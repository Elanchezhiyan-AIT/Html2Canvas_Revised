                            ...
                            h = f.styles.backgroundImage.length - 1, e = function(e) {
                                ...
                                return H(this, function(A) {
                                    switch (A.label) {
                                        ...
                                        case 4:
                                            return t && (B = Cs(f, h, [t.width, t.height, t.width == 0 ? 0 : t.width / t.height]), o = B[0], g = B[1], w = B[2], c = B[3], a = B[4], s = d.ctx.createPattern(d.resizeImage(t, c, a), "repeat"), d.renderRepeat(o, s, g, w)), [3, 6];
                                        case 5:
